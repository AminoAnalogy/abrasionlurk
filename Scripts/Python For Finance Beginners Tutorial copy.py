...
r= requests.get("https://financialmodelingprep.com/api/v3/historical-price-full/AAPL?apikey=31fa1a9122c9b0d18024b5eb2d9ef148")
r = r.json()
ourdata = r['historical']
df = pd.DataFrame.from_dict(ourdata, orient='columns')
...
df = pd.DataFrame(df, columns=['open', 'high', 'low', 'close', 'volume', 'adjClose'])
df.index
df
